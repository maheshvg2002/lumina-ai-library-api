...
1. **Hardware Constraints:** Assuming the system will be evaluated on standard hardware without a dedicated high-end GPU, the Docker Compose file is configured to pull an efficient, quantized model (`tinyllama`). 
